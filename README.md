...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/%3C%201374%20lines-59C6B5?style=flat&label=source&labelColor=0E2426&logo=files&logoColor=59C6B5" />
  <img src="https://img.shields.io/badge/1.5.1-6CD4B5?style=flat&label=version&labelColor=0E2426&logo=tag&logoColor=6CD4B5" />
  &nbsp;
  ...
  <img src="https://img.shields.io/badge/FreeBSD-A4FBB6?style=flat&labelColor=0E2426&logo=freebsd&logoColor=A4FBB6" />
  &nbsp;
...
dwm's bar and font rendering alone account for a significant portion of its codebase. `nwm` drops all of that. No drawing, text, color schemes beyond three border hex values
...
| OpenBSD | `pledge(2)` support; also builds on FreeBSD (I can't be bothered to check,I think it works)|
| Compilation | Clean under `gcc or clang -std=c99 -pedantic -Wall -Wextra` |
...
<img src="https://raw.githubusercontent.com/tinyopsec/distrohop/main/assets/alpine.webp"
     width="49%"
     alt="nwm on Alpine Linux rice, my pc btw: three terminals tiled in master/stack layout">
...
I removed all the comments from the code before uploading it, because they were in Russian.
